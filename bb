...
local function UVPHZY_fake_script() -- TextButton.LocalScript 
...
coroutine.wrap(UVPHZY_fake_script)()
local function SXJG_fake_script() -- TextButton.LocalScript 
	local script = Instance.new('LocalScript', TextButton)
	...
	local function runTeleportation()
		while isEnabled do
			spame() -- spame fonksiyonunu çağır
...
coroutine.wrap(SXJG_fake_script)()
local function BVMPJMH_fake_script() -- Close.LocalScript 
...
coroutine.wrap(BVMPJMH_fake_script)()
local function POPJTM_fake_script() -- TextButton_2.LocalScript 
...
coroutine.wrap(POPJTM_fake_script)()
local function QQWBVON_fake_script() -- ScreenGui.LocalScript 
...
coroutine.wrap(QQWBVON_fake_script)()
