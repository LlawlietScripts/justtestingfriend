...
local function TQOPR_fake_script() -- TextButton.LocalScript 
...
coroutine.wrap(TQOPR_fake_script)()
local function NXQAB_fake_script() -- TextButton.LocalScript 
	local script = Instance.new('LocalScript', TextButton)
...
coroutine.wrap(NXQAB_fake_script)()
local function MJHPNYS_fake_script() -- Close.LocalScript 
...
coroutine.wrap(MJHPNYS_fake_script)()
local function TVMW_fake_script() -- TextButton_2.LocalScript 
...
coroutine.wrap(TVMW_fake_script)()
local function PCSRDCA_fake_script() -- ScreenGui.LocalScript 
...
coroutine.wrap(PCSRDCA_fake_script)()
